...
(function () {
  ...
  const ICON_SEARCH = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>';

  const ICON_AI = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><path d="M8 10h.01"/><path d="M12 10h.01"/><path d="M16 10h.01"/></svg>';
  ...
  function renderNav() {
    ...
    nav.innerHTML = `
      ...
      <div class="nav-tools">
        ...
        <button class="nav-btn" id="search-btn" title="搜索 (Ctrl+K)" onclick="typeof SiteSearch!=='undefined'&&SiteSearch.toggle()">
          ${ICON_SEARCH}
        </button>
